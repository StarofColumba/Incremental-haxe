...
@:dox(hide) class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("Incrementalhaxe", create);
	...
	public static function create(config:Dynamic):Void
	{
		...
		app.meta.set("file", "Incrementalhaxe");
		app.meta.set("name", "Incrementalhaxe");
		app.meta.set("packageName", "com.sample.incrementalhaxe");
		...
		#elseif air
		app.window.title = "Incrementalhaxe";
		#else
